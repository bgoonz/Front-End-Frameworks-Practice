  ...
  (function ($, undefined) {
    $.widget("mobile.listview", $.mobile.listview, {
      ...
      submitTo: function () {
        ...
        form.attr("method", "get").attr("action", this.options.submitTo);
      ...
      highlightDown: function () {
        if (
          this.element.find("li.ui-btn-active").hasClass("ui-screen-hidden")
        ) {
          this.element
            .find("li.ui-btn-active")
            .find("a")
...
$(document).on("pagebeforecreate", "[data-role='page']", function () {
  $(this)
    .find("[data-demo-html], [data-demo-js], [data-demo-css], [data-demo-php]")
    .viewSourceCode();
